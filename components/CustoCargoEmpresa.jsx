    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 py-12 px-4">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8 mb-8 animate-fade">
          ...
          <input type="number" value={salario} onChange={(e) => setSalario(parseFloat(e.target.value) || 0)} className="w-full px-4 py-3 border-2 border-slate-300 rounded-lg focus:outline-none focus:border-blue-500 text-lg font-semibold text-slate-800" aria-label="Digite o salário" />
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8 animate-fade" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
            {[
              ...
              <div key={idx} className="rounded-lg p-4 text-center font-semibold text-slate-700 shadow-sm border border-slate-200 hover:shadow-md transition-shadow" style={{ backgroundColor: membro.cor }}>
                {membro.nome}
              </div>
            ))}
          </div>
